...
## 풀이
<p> 가장 빠른 시간은 BFS를 이용해서 간단하게 풀 수 있었으나, 경우의 수를 생각하는데 시간이 좀 걸렸던 문제 </p>
<p> "모든 경우의 수" 가 아니라 "가장 빠른 경우의 수" 인것을 감안하면 조건이 상당히 간단해지지만 여기까지의 생각에 다다르기가 어려웠다. </p>
<p> 그리고 언제나 예외값 생각하기를 좀 더 연습하자!! </p>
